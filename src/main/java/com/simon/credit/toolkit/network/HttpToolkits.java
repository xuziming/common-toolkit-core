...
public class HttpToolkits {
    ...
    static {
        ...
        try {
            ...
            SSL_CONTEXT.getClientSessionContext().setSessionTimeout(15);
            SSL_CONTEXT.getClientSessionContext().setSessionCacheSize(1000);
    ...
    public static String doPost(String url, String ctype, String content, String charset,
        ...
        try {
            ...
            byte[] outputBytes = {};
            if (content != null) {
                outputBytes = content.getBytes(charset);
            }
    ...
    private static HttpURLConnection getConnection(URL url, String method, String ctype) throws IOException {
        ...
        if ("https".equals(url.getProtocol())) {
            ...
            connHttps.setSSLSocketFactory(SOCKET_FACTORY);
    ...
    private static URL buildGetUrl(String strUrl, String query) throws IOException {
        ...
        if (CommonToolkits.isEmptyContainNull(query)) {
            return url;
        }

        if (CommonToolkits.isEmptyContainNull(url.getQuery())) {
            if (strUrl.endsWith("?")) {
                strUrl = strUrl + query;
            } else {
                strUrl = strUrl + "?" + query;
    ...
    public static String buildQuery(Map<String, String> params, String charset) throws IOException {
        ...
        for (Entry<String, String> entry : entries) {
            ...
            // 忽略参数名或参数值为空的参数
            if (CommonToolkits.isNotEmpty(name)) {
                if (hasParam) {
                    query.append("&");
                } else {
                    hasParam = true;
    ...
    private static String getResponseAsString(HttpURLConnection conn) throws IOException {
        ...
        if (es == null) {
            ...
            if (CommonToolkits.isEmptyContainNull(msg)) {
    ...
    private static String getResponseCharset(String ctype) {
        ...
        if (CommonToolkits.isNotEmpty(ctype)) {
            ...
            for (String param : params) {
                ...
                if (param.startsWith("charset")) {
                    ...
                    if (pair.length == 2) {
                        if (CommonToolkits.isNotEmpty(pair[1])) {
                            charset = pair[1].trim();
                        }
                    }
                    break;
