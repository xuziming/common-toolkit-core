...
public class MyRandom implements Serializable {
	...
	static final class RandomIntsSpliterator implements Spliterator.OfInt {
		...
		RandomIntsSpliterator(MyRandom rng, long index, long fence, int origin, int bound) {
			this.rng = rng;
			this.index = index;
			this.fence = fence;
			this.origin = origin;
	...
	static final class RandomLongsSpliterator implements Spliterator.OfLong {
		...
		RandomLongsSpliterator(MyRandom rng, long index, long fence, long origin, long bound) {
			this.rng = rng;
			this.index = index;
			this.fence = fence;
			this.origin = origin;
	...
	static final class RandomDoublesSpliterator implements Spliterator.OfDouble {
		...
		RandomDoublesSpliterator(MyRandom rng, long index, long fence, double origin, double bound) {
			this.rng = rng;
			this.index = index;
			this.fence = fence;
			this.origin = origin;
	...
	static {
		try {
			seedOffset = unsafe.objectFieldOffset(MyRandom.class.getDeclaredField("seed"));
		} catch (Exception ex) {
			throw new Error(ex);
		}
	}
