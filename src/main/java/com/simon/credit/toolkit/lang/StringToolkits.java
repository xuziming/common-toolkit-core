...
import com.simon.credit.toolkit.codec.binary.Charsets;

public class StringToolkits {
	...
	public static boolean equals(final CharSequence cs1, final CharSequence cs2) {
		...
		return CharSequenceToolkits.regionMatches(cs1, false, 0, cs2, 0, Math.max(cs1.length(), cs2.length()));
	}
	...
	public static byte[] getBytesUnchecked(final String string, final String charsetName) {
		...
		try {
			...
			throw StringToolkits.newIllegalStateException(charsetName, e);
		}
	}
